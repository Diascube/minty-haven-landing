...
const menuData: Record<Category, MenuItem[]> = {
  "Кофе": [
    { name: "Эспрессо", desc: "Насыщенный шот из свежеобжаренных зёрен, крепкий и ароматный", price: "$3.50" },
    { name: "Американо", desc: "Эспрессо, разбавленный горячей водой — мягкий и бодрящий", price: "$5.00" },
    { name: "Латте", desc: "Нежный эспрессо с большим количеством взбитого молока и лёгкой пенкой", price: "$5.50" },
    { name: "Капучино", desc: "Равные части эспрессо, горячего молока и воздушной молочной пены", price: "$4.50" },
    { name: "Флэт Уайт", desc: "Двойной ристретто с бархатной микропеной — крепкий и сливочный", price: "$5.50" },
    { name: "Бамбл-Кофе", desc: "Холодный эспрессо с апельсиновым соком и карамельным сиропом", price: "$4.50" },
  ],
  "Напитки": [
